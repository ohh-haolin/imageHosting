...
function init() {
    ...
    var html = `
<header class="mdui-appbar mdui-color-theme" style="background-color: #1f99d5 !important;"> 
...
function nav(path) {
    ...
    html += `<a href="https://hlz.ink" class="mdui-typo-headline folder" target="_blank" style="position: relative;left: 70%;">Myblog</a>`;
